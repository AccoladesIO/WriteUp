  ...
  return (
    <div style={{background: `${color}`}} className=' drop-shadow-md fixed left-0 top-0 w-full z-10 ease-in duration-300'>
        <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white'>
            ...
            {/* Mobile Menu */}
            <div className={
                nav ? 'sm:hidden absolute top-0 left-0 right-[-10%] bottom-0 flex justify-center items-center w-[350px] h-screen bg-white text-left ease-in duration-300' : 
                'sm:hidden absolute top-0 left-[-100%] right-0 bottom-0 flex justify-center items-center w-[0] h-screen bg-white text-left ease-in duration-300'
         }>
