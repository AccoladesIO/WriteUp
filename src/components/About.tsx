...
const About = () => {
    return (
        ...
        <div className='flex flex-wrap-reverse md:flex-nowrap justify-between items-center p-4 max-w-[1024px] mx-auto min-h-[500px] my-8' id='about'>
        ...
        <div className='w-full md:w-[90%] mx-auto my-8'>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1w-full gap-4 mt-4'>
                <div className='border border-gray-200 rounded-md  p-4 w-full h-full flex flex-col gap-2'>
